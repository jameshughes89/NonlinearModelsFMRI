'''
prints the matrix for generated for linear on LR on RL data.
'''
...
iFile =  csv.reader(open('abEmat_L_RL.csv', 'r'))
...
iFile =  csv.reader(open('msEmat_L_RL.csv', 'r'))
mseMat = []
for l in iFile:
	mseMat.append(l)
...
#######
#######
iFile =  csv.reader(open('minmat_L_RL.csv', 'r'))
