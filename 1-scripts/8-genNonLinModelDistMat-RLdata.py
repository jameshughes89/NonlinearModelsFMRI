...
np.savetxt('msEmat_NL_RL_opt.csv', matrixMSE, delimiter=",")
np.savetxt('abEmat_NL_RL_opt.csv', matrixABE, delimiter=",")
np.savetxt('minmat_NL_RL_opt.csv', matrixMIN, delimiter=",")
