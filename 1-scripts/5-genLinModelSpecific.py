...
for t in tasks:
	bestExpressions = []
	oFile = open('./topModels/bestExpressions-L-SINGLE' + '-' + t + '-RL.txt','w')	
	o2File = open('./topModels/bestExpressionsError-L-SINGLE' + '-' + t + '-RL.txt','w')	
	fs='funcsL = ['
	count = 0
	for s in subjects:
		try:		
			...
			#topX = np.argsort(corrC[-1,:])[-1*TOPX:]		#I actually don't think I should have the following because I count the 1 as a DF with the NL 		#CHANGE ME (remember, if you want 6, you need -7 (exclude itself))
			#topX = np.sort(topX)
			...
			oFile.write('def funcLS_' + str(subjects[count]) + '(v0,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,v22,v23,v24,v25,v26,v27,v28,v29): return ' + eqn + '\n')		#CHANGE HERE (in function name)
